...
urlpatterns = [
    ...
    # Review URLs
    path('rental/<int:rental_pk>/review/', views.ReviewCreateView.as_view(), name='create_review'),

    # Authentication URLs
    path('login/', auth_views.LoginView.as_view(template_name='login.html'), name='login'),
    path('logout/', auth_views.LogoutView.as_view(next_page='rental_platform:home'), name='logout'),
