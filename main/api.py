...
class ToolViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        queryset = Tool.objects.annotate(
            average_rating=Avg("rental__review__rating"), total_rentals=Count("rental")
        )
        return queryset
...
class RentalViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return Rental.objects.filter(models.Q(renter=user) | models.Q(tool__owner=user))
...
class TransactionViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return Transaction.objects.filter(
            models.Q(rental__renter=user) | models.Q(rental__tool__owner=user)
        )
